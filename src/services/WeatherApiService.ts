...
const API_URL: string = import.meta.env.VITE_WEATHER_API_URL;
...
export class WeatherApiService {
  getCurrentWeather(
    ...
    let CURRENT_WEATHER_URL: string = `${API_URL}?lat=${coord?.lat}&lon=${coord?.lon}&appid=${API_KEY}&units=metric`;
